...
<%
  ...
  database.ConnectDB();
  if(p_name != null &&  p_photo != null && p_location !=null && p_description !=null){
    database.ConnectDB();
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          <form id = "form<%=id%>" action="index.jsp" method="POST">
                                            ...
                                            <td>
                                              <button id = "delete1" type="button" class="btn btn-danger">刪除</button>
                                            </td>
                                          </form>
                                        </tr>
                                        <%}}%>
      ...
      $("button").on("click",function(){
        ...
        switch(click_text){
          case"修改":
            ...
            $("#description" + id).html('<textarea name="description" id = "input_description' + id + '">'+$("#description" + id).text()+'</textarea>');
