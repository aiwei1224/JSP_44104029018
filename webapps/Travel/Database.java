...
public class Database{
  ...
  public void insertData(String name , String location , String photo , String description){
    try{
      String sql = "insert into travel_travel(name,location,photo,description) value(?,?,?,?)";
  ...
  public void editData(String id , String name , String location , String photo , String description){
    try{
      String sql = "update travel_travel set name ='"+name+"',location ='"+location+"',photo ='"+photo+"',description ='"+description+"' where id =" +id;
